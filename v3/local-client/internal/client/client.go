...
import (
	...
	"videowithyou/v3/local-client/internal/adapter"
	"videowithyou/v3/local-client/internal/bridge"
	"videowithyou/v3/local-client/internal/config"
	"videowithyou/v3/local-client/internal/model"
	"videowithyou/v3/local-client/internal/ntp"
	"videowithyou/v3/local-client/internal/syncer"
	"videowithyou/v3/local-client/internal/ws"
